...
define root view entity Z14_I_FlightWithGeo
  as select from z14_flights     as Flights
    inner join   /dmo/connection as _Connection on  Flights.carrier_id    = _Connection.carrier_id
                                                and Flights.connection_id = _Connection.connection_id

  association [0..1] to z14_airports_geo as _DepartureGeo on _Connection.airport_from_id = _DepartureGeo.airport_id

  association [0..1] to z14_airports_geo as _ArrivalGeo   on _Connection.airport_to_id = _ArrivalGeo.airport_id
{
  key Flights.uuid                      as UUID,
      ...
      //    WEATHER
      cast( '' as z14_weather_status )  as DepartureWeatherStatus,
      cast( 0.0 as z14_temperature  )   as DepartureTemperature,

      cast( '' as z14_weather_status  ) as ArrivalWeatherStatus,
      cast( 0.0 as z14_temperature )    as ArrivalTemperature,
